...
class Subscription
{
    ...
    public function getPaymantStatus(): ?string
    {
        return $this->paymant_status;
    }

    public function setPaymantStatus(?string $paymant_status): self
    {
        $this->paymant_status = $paymant_status;
